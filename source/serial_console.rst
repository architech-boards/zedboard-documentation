...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="serial_console_rst-host-133" class="language-markup">[29629.785374] usb 3-2: &gt;new full-speed USB device number 4 using xhci_hcd
