...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'install_scripts_rst-host-201' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="install_scripts_rst-host-201" class="language-markup">git clone -b dora https://github.com/architech-boards/machine_installer.git
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'install_scripts_rst-host-202' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="install_scripts_rst-host-202" class="language-markup">git clone -b dora https://github.com/architech-boards/zedboard-splashscreen.git
